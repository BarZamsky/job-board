...
export function SidebarOrgButtonClient({ user, organization }: { user: User; organization: Organization }) {
    ...
    return (
        <DropdownMenu>
            ...
            >
                ...
                >
                    <Building2Icon size={2} className="mr-1" /> Manage Organization
                </DropdownMenuItem>
                ...
                <SignOutButton>
                    <DropdownMenuItem>
                        <LogOutIcon size={2} className="mr-1" /> Log Out
                    </DropdownMenuItem>
                </SignOutButton>
            </DropdownMenuContent>
        </DropdownMenu>
...
export function OrganizationInfo({ user, organization }: { user: User; organization: Organization }) {
